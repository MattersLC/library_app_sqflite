...
class _SolicitudesPageState extends State<SolicitudesPage> {
  ...
  Future<void> _getSolicitudes() async {
    List<Solicitud>? solicitudes = await DatabaseHelper.getAllSolicitudes();
    if (solicitudes != null) {
      await DatabaseHelper.updateSolicitudConRetraso(solicitudes);
      List<Solicitud>? solicitudesFinal =
          await DatabaseHelper.getAllSolicitudes();
      setState(() {
        _solicitudesPage = solicitudesFinal!;
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _solicitudesPage.isEmpty
          ...
          : ListView.builder(
              itemCount: _solicitudesPage.length,
              itemBuilder: (context, index) =>
                  solicitudesTile(_solicitudesPage[index]),
            ),
    );
  }
