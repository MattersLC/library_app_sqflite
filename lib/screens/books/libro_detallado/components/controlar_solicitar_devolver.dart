...
class _ControlarRequisitarEDevolverState
  ...
  DatabaseHelper? _referenciaRequisicao;
  DatabaseHelper? _referenciaUID;
  DatabaseHelper? _referenciaDataRequisicao;
  DatabaseHelper? _referenciaDataEntrega;
  DatabaseHelper? _referenciaIncrementar;
  DatabaseHelper? _referenciaIdHistorico;

  DatabaseHelper baseDeDados = DatabaseHelper();
